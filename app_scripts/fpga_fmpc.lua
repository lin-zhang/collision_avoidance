...
ubx.load_module(ni, "std_blocks/lfds_buffers/lfds_cyclic.so")
ubx.load_module(ni, "std_blocks/udp_client_port/udp_client_port.so")
...
udp_client_port1=ubx.block_create(ni, "udp_client_port/udp_client_port", "udp_client_port1", {udp_client_port_config={port=51068, host_ip='192.168.10.169'}})
...
print("creating instance of 'lfds_buffers/cyclic'")
fifo4=ubx.block_create(ni, "lfds_buffers/cyclic", "fifo4", {element_num=4, element_size=64})
...
p_fmpc_msr_odom=ubx.port_get(fmpc1, 'msr_odom_port');
...
ubx.port_connect_out(p_fmpc_msr_odom, fifo4);
ubx.port_connect_in(client_in_port, fifo4);
...
assert(ubx.block_init(udp_client_port1)==0)
...
assert(ubx.block_start(udp_client_port1)==0)
