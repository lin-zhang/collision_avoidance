...
ptrig3=ubx.block_create(ni, "std_triggers/ptrig", "ptrig3",
                        { period={sec=0, usec=10000 }, sched_policy="SCHED_FIFO", sched_priority=40,
