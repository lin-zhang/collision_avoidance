...
serial_read1=ubx.block_create(ni, "serial_read/serial_read", "serial_read1", {serial_read_config={portName='/dev/ttyACM0', brate=38400}})
...
ptrig2=ubx.block_create(ni, "std_triggers/ptrig", "ptrig2",
                        { period={sec=0, usec=5000 }, sched_policy="SCHED_FIFO", sched_priority=80,
