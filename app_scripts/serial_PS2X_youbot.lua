...
ubx.load_module(ni, "arduino_blocks/ps2x_youbot_vel/ps2x_youbot_vel.so")
...
print("creating instance of 'lfds_buffers/cyclic'")
fifo3=ubx.block_create(ni, "lfds_buffers/cyclic", "fifo3", {element_num=4, element_size=4})


print("creating instance of 'logging/file_logger'")

print("creating instance of 'serial_read/serial_read'")
serial_read1=ubx.block_create(ni, "serial_read/serial_read", "serial_read1", {serial_read_config={portName='/dev/ttyACM0', brate=57600}})

print("creating instance of 'ps2x_youbot_vel/ps2x_youbot_vel'");
ps2x_youbot_vel1=ubx.block_create(ni, "ps2x_youbot_vel/ps2x_youbot_vel", "ps2x_youbot_vel1", {ps2x_youbot_vel_config={delim=','}})
...
--   { blockname='ptrig1', portname="tstats", buff_len=3, },
   { blockname='ps2x_youbot_vel1', portname="data_out", buff_len=3,data_type="int"},
   { blockname='ps2x_youbot_vel1', portname="nData", buff_len=3,data_type="unsigned int"},
}
]]
...
ptrig1=ubx.block_create(ni, "std_triggers/ptrig", "ptrig1",
			{
			   ...
			   trig_blocks={ { b=arduino_upload1, num_steps=1, measure=0 },
					 ...
					 { b=ps2x_youbot_vel1, num_steps=1, measure=0 },	
...
print("running ptrig1 init", ubx.block_init(ptrig2))
...
print("running ps2x_youbot_vel1 init", ubx.block_init(ps2x_youbot_vel1))
...
ps2x_youbot_vel_in_port=ubx.port_get(ps2x_youbot_vel1, "string_in");
ubx.port_connect_out(serial_read_out_port, fifo2);
ubx.port_connect_in(ps2x_youbot_vel_in_port, fifo2);

youbot_cmd_vel_port=ubx.port_get(youbot1, "base_cmd_vel");
ps2x_youbot_cmd_vel_port=ubx.port_get(ps2x_youbot_vel1, "base_cmd_vel");
...
ubx.block_start(ps2x_youbot_vel1)
