...
fifo5=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo5", {element_num=4, element_size=512})
...
print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo1=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo1", {element_num=4, element_size=48})
print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo2=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo2", {element_num=4, element_size=96})
print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo3=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo3", {element_num=4, element_size=48})

print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo4=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo4", {element_num=4, element_size=512})

print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo6=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo6", {element_num=4, element_size=512})

print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo7=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo7", {element_num=4, element_size=512})

print("creating instance of 'lfds_buffers/cyclic_raw'")
fifo8=ubx.block_create(ni, "lfds_buffers/cyclic_raw", "fifo8", {element_num=4, element_size=512})
